...
const skills = [
	...
	{
		title: '小說',
		description: '總是喜歡幻想小說的事在現實中發生',
	},
	{
		title: '對手工藝完全不行',
		description: '手工藝從國小就被老師放棄了',
	},
	{
		title: '喜歡睡覺',
		description: '跟床總是分不開',
		...
		<div class="flex flex-wrap justify-start">
			<div
				...
				<div
				  ...
				  <h4 class="text-gray-1000 text-lg text-center mb-2">{{ skill.title }}</h4> 
				  <p class="text-gray-400-lg text-center mb-2">{{ skill.description }}</p> 
				</div>
			</div>
		</div>
	</section>
